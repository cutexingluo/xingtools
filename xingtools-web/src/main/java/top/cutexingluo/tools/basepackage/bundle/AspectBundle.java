...
public class AspectBundle implements IAspectBundle {
    ...
    public AspectBundle(Method method, HttpServletRequestData request) {
        this.method = method;
        this.request = request;
    }

    public AspectBundle(Method method, HttpServletRequestData request, @Nullable ProceedingJoinPoint joinPoint) {
        this.method = method;
        this.request = request;
        this.joinPoint = joinPoint;
    }

    public AspectBundle(Method method, HttpServletRequestData request, @Nullable ProceedingJoinPoint joinPoint, @Nullable Object result) {
        this.method = method;
        this.request = request;
        this.joinPoint = joinPoint;
        this.result = result;
